...
//MARK: - Card Zoom
struct DiscoveryCardZoomModifier: ViewModifier {
...
struct DiscoveryView<Content: View>: View {
	...
	init(data: [Any], model: DiscoveryViewModel, @ViewBuilder viewBuilder: @escaping (Any) -> Content) {
		self.data = data
...
struct DiscoveryView_Preview: PreviewProvider {
